...
class AES128CBCDecryptionButton extends VMenuItem {
    private MainPanel mainPanel;
    private PasswordDialog dialog;

    AES128CBCDecryptionButton(MainPanel mainPanel) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(image!=null && password!=null) {
            ...
            try {
                mainPanel.getImagePanel().setImage(CustomImage.getImageFromBytes(cipher.decrypt(), image.width, image.height));
